...
import '../../core/exceptions/repository_excetion.dart';
...
class PaymentTypeRepositoryImpl implements PaymentTypeRepository {
  ...
  Future<List<PaymentTypeModel>> findAll(bool? enabled) async {
    try {
      ...
      throw RepositoryExcetion(message: 'Erro ao buscar formas de pagamento');
    }
  }
  ...
  Future<PaymentTypeModel> getById(int id) async {
    try {
      ...
      throw RepositoryExcetion(message: 'Erro ao buscar formas de pagamento $id');
    }
  }
  ...
  Future<void> save(PaymentTypeModel model) async {
    try {
      ...
      throw RepositoryExcetion(message: 'Erro ao salvar forma de pagamento');
    }
  }
}
